...
namespace bookmanager
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            pages = Convert.ToInt32(textBox1.Text); // количество книг
            ...
            client.Headers.Add(HttpRequestHeader.AcceptCharset, "UTF-8");//помен кодировк
            while (pages > 0)
            {
                ...
                //  catch (System.Net.WebException t)
                //   {
                //  var s = t.Message;
